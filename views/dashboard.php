      ...
      <div class="container my-container mt-5">
        ...
        <div class="row my-row">
          ...
          <div class="my-btn-group">
            <!-- <p>Add new Company</p> -->
            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModal">Company</button>
            <!-- <p>Add new Product</p> -->
            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModal2">Product</button>
            <!-- <p>Add new Hose Type</p> -->
            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModal3">Hose Type</button>
          </div>
          </div>
        </div>
